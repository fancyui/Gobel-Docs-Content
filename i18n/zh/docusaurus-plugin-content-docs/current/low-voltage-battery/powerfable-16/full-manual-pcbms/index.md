...
2. **连接电脑上位机设置**：使用 **RS232-USB 通讯线（[05](#Part05)）** 连接 Windows 系统电脑与主机电池，在电脑上位机程序软件中选择与逆变器匹配的通讯协议。
   ...
   :::note
   上位机详细操作请参见[参考文件](#Reference-Documents)章节中的《上位机操作流程文档》。
   :::
...
| 上位机操作流程文档 | 电脑上位机软件的安装与详细操作说明 | 预留上位机详细操作指南链接 |
| Gobel Console APP 使用说明 | 手机 APP 的连接、一键配置和升级操作 | 预留 Gobel Console APP 使用说明链接 |
