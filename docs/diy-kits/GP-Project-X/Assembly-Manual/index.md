...
| :-------------------: | :------------------: | :--------------: | :-------------------------------: |
| <a id="Part01">01</a> |         Base         |       1 pc        |    ![Base](images/gp-px-base.jpg) |
| <a id="Part02">02</a> |       Metal Frame       |       2 pcs        |    ![Metal Frame](images/frame-cells.jpg) |
| <a id="Part03">03</a> |       Enclosure Back Panel       |       1 pc        |    ![Enclosure Back Panel](images/case-back.jpg) |
| <a id="Part04">04</a> |       Enclosure Front Panel       |       1 pc        |    ![Enclosure Front Panel](images/case-front.jpg) |
| <a id="Part05">05</a> |       Enclosure Side Panel       |       2 pcs        |    ![Enclosure Side Panel](images/case-side.jpg) |
| <a id="Part06">06</a> |       Enclosure Top Cover       |       1 pc        |    ![Enclosure Top Cover](images/case-top.jpg) |
| <a id="Part07">07</a> |    Moving Cell Compression Side Plate  |       2 pcs        |    ![Moving Cell Compression Side Plate](images/gp-px-moving-compression-plate.jpg) |
| <a id="Part08">08</a> |      H-Aluminum Alloy Slot Strip     |       4 pcs        |    ![H-Aluminum Alloy Slot Strip](images/h-slot-strip.jpg) |
| <a id="Part09">09</a> |     JK BMS 200A      |       1 pc        |    ![JK BMS 200A](images/jk-bms-200a.jpg) |
| <a id="Part10">10</a> |    JK BMS Communication Board     |       1 pc        |    ![JK BMS Communication Board](images/jk-comm-pcb.jpg) |
| <a id="Part11">11</a> |    Voltage Detection PCB Board A    |       1 pc        |    ![Voltage Detection PCB Board A](images/pcb-wiring-a.jpg) |
| <a id="Part12">12</a> |    Voltage Detection PCB Board B    |       1 pc        |    ![Voltage Detection PCB Board B](images/pcb-wiring-b.jpg) |
| <a id="Part13">13</a> |      Cell Epoxy Board      |      18 pcs        |    ![Cell Epoxy Board](images/epoxy-sheet-314.jpg) |
| <a id="Part14">14</a> |    Cell Bottom Insulation Film    |       4 pcs        |    ![Cell Bottom Insulation Film](images/film-cell-bottom.jpg) |
| <a id="Part15">15</a> |      BMS Mounting Plate       |       1 pc        |    ![BMS Mounting Plate](images/gp-px-bms-plate-.jpg) |
| <a id="Part16">16</a> |   BMS-Circuit Breaker Busbars   |       1 pc        |    ![BMS-Circuit Breaker Busbars](images/barsbar-bms-breaker.jpg) |
| <a id="Part17">17</a> |   Cell 8-9 Busbars      |       1 pc        |    ![Cell 8-9 Busbars](images/busbar-8-9.jpg) |
| <a id="Part18">18</a> |     Cell Series Busbars   |      14 pcs        |    ![Cell Series Busbars](images/busbar-314.jpg) |
| <a id="Part19">19</a> | Circuit Breaker-Battery Negative Output Terminal Busbars |   1 pc    |    ![Circuit Breaker-Battery Negative Output Terminal Busbars](images/busbar-breaker-pack-n.jpg) |
| <a id="Part20">20</a> |   BMS-Cell Total Negative Busbars |      1 pc        |    ![BMS-Cell Total Negative Busbars](images/busbar-cell-n-bms.jpg) |
| <a id="Part21">21</a> |  Fuse-Cell Total Positive Busbars |     1 pc        |    ![Fuse-Cell Total Positive Busbars](images/busbar-cell-p-fuse.jpg) |
| <a id="Part22">22</a> | Fuse-Battery Positive Output Terminal Busbars | 1 pc    |    ![Fuse-Battery Positive Output Terminal Busbars](images/busbar-fuse-pack-p.jpg) |
| <a id="Part23">23</a> |     Circuit Breaker Extension Lug   |       4 pcs        |    ![Circuit Breaker Extension Lug](images/breaker-stinger-lug.jpg) |
| <a id="Part24">24</a> |      Cell Metal Pressing Strip    |       2 pcs        |    ![Cell Metal Pressing Strip](images/pressing-strip.jpg) |
| <a id="Part25">25</a> |        Insulator        |       2 pcs        |    ![Insulator](images/Insulator.jpg) |
| <a id="Part26">26</a> | USB-RS485(RS232) Communication Cable |     1 pc        |    ![USB-RS485 Communication Cable](images/cable-usb-rs.jpg) |
| <a id="Part27">27</a> |    Battery Negative Output Terminal  |       1 pc        |    ![Battery Negative Output Terminal](images/terminal-pack-n.jpg) |
| <a id="Part28">28</a> |    Battery Positive Output Terminal  |       1 pc        |    ![Battery Positive Output Terminal](images/terminal-pack-p.jpg) |
| <a id="Part29">29</a> |      Metal Push Button Switch    |       1 pc        |    ![Metal Push Button Switch](images/push-button-switch.jpg) |
| <a id="Part30">30</a> |   JK BMS 4.5-inch Screen |       1 pc        |    ![JK BMS 4.5-inch Screen](images/jk-screen-4.jpg) |
| <a id="Part31">31</a> |        Caster          |   4 pcs (40kg load capacity each) |    ![Caster](images/2-inch-wheel.jpg) |
| <a id="Part32">32</a> |        Circuit Breaker        | 1 pc, 2P100A (total 200A) |    ![Circuit Breaker](images/2p100a-breaker.jpg) |
| <a id="Part33">33</a> |        Fuse        | 1 pc, 250A Class-T |    ![Fuse](images/fuse-200a.jpg) |
...
Place the **Base ([01](#Part01))** on the workbench, and install the **Casters ([31](#Part31))** on the four corners of the base bottom, ensuring the caster directions are consistent and they can rotate normally.

![Base Assembly](images/assem-gp-px-base-full.jpg)

### 2. Enclosure Front Panel Assembly

Place the **Enclosure Front Panel ([04](#Part04))** face up, and install the **JK BMS 4.5-inch Screen ([30](#Part30))** and **Metal Push Button Switch ([29](#Part29))** into the corresponding openings on the enclosure front panel, securing them with screws.

![Enclosure Front Panel Assembly](images/assem-case-front.jpg)

### 3. Negative Enclosure Side Panel Assembly

Lay one **Enclosure Side Panel ([05](#Part05))** flat, and install the **Battery Negative Output Terminal ([27](#Part27))** onto the corresponding position on the side panel, securing it with screws. Confirm the terminal orientation is correct.

![Negative Enclosure Side Panel Assembly](images/assem-case-side-n.jpg)

### 4. Positive Enclosure Side Panel Assembly

Lay the other **Enclosure Side Panel ([05](#Part05))** flat, and install the **Battery Positive Output Terminal ([28](#Part28))** onto the corresponding position on the side panel, securing it with screws.
...
Insert the **Circuit Breaker Extension Lugs ([23](#Part23))** into the four terminal ports of the **Circuit Breaker ([32](#Part32))** respectively, and secure them with screws. Ensure each lug has good contact with the terminal port.

![Circuit Breaker Assembly](images/assem-breaker.jpg)

### 6. BMS Assembly

Use the **BMS Mounting Plate ([15](#Part15))** as the base, and install the following components in sequence:
- Install the **JK BMS 200A ([09](#Part09))** onto the BMS mounting plate
- Install the **JK BMS Communication Board ([10](#Part10))** next to the BMS
- Install the **Insulators ([25](#Part25))** onto the corresponding positions of the mounting plate (for fixing the fuse)
- Install the **Fuse ([33](#Part33))** onto the insulators
- Install the assembled **Circuit Breaker Assembly** onto the BMS mounting plate
- Use the **BMS-Circuit Breaker Busbars ([16](#Part16))** to connect the BMS and circuit breaker

![BMS Assembly](images/assem-gp-px-bms-plate.jpg)

### 7. Lower Cell Module Assembly (Cells 9-16)

Lay the **Metal Frame ([02](#Part02))** flat on the workbench, and assemble the lower cell module according to the following steps:
...
b. Lay the **Cell Bottom Insulation Film ([14](#Part14))** on the bottom of the metal frame. Place the cells according to the diagram, and use the **Cell Series Busbars ([18](#Part18))** to connect the cells in series sequentially.
...
c. Install the **Moving Cell Compression Side Plate ([07](#Part07))** on the other side of the metal frame, and adjust the compression force on the cells by adjusting the 4 screws on the side plate, ensuring the cells are tightly arranged but not excessively squeezed.

![Adjusting Cell Compression Side Plate](images/assem-cells-side.jpg)

d. Place the **Cell Metal Pressing Strip ([24](#Part24))** on top of the cells, and secure them with screws onto the fixed side plate and the moving cell compression side plate.
...
e. Place the **Voltage Detection PCB Board B ([12](#Part12))** on the cell metal pressing strip, with the end of the PCB board with terminals facing left. Then connect the detection wires on Voltage Detection PCB Board B to the corresponding cell busbars sequentially.
...
- Use **Voltage Detection PCB Board A ([11](#Part11))** instead of Voltage Detection PCB Board B
...
Place the assembled base assembly on the ground, and check whether all four **Casters ([31](#Part31))** are securely fixed and can rotate and lock normally.
...
Use the **Cell 8-9 Busbars ([17](#Part17))** to connect Cell 8 at the top of the lower module with Cell 9 at the bottom of the upper module, completing the series connection of the 16 cells.
...
- Use the **Fuse-Cell Total Positive Busbars ([21](#Part21))** to connect the positive pole of Cell 16 with the **Fuse ([33](#Part33))**
- Use the **BMS-Cell Total Negative Busbars ([20](#Part20))** to connect the negative pole of Cell 1 with the **JK BMS 200A ([09](#Part09))**
...
Install each enclosure assembly onto the base, **positive side panel on the left, negative side panel on the right**. Connect the cables of the **JK BMS 4.5-inch Screen ([30](#Part30))** and **Metal Push Button Switch ([29](#Part29))** to the BMS.

![Installing Enclosure Assembly](images/gp-px-step6.jpg)

### 8. Connect Output Terminals

- Use the **Circuit Breaker-Battery Negative Output Terminal Busbars ([19](#Part19))** to connect the circuit breaker with the **Battery Negative Output Terminal ([27](#Part27))**
- Use the **Fuse-Battery Positive Output Terminal Busbars ([22](#Part22))** to connect the fuse with the **Battery Positive Output Terminal ([28](#Part28))**

![Connecting Output Terminals](images/gp-px-step7.jpg)

### 9. Secure Enclosure Side Panels

Insert the **H-Aluminum Alloy Slot Strips ([08](#Part08))** into the gaps between the enclosure side panels and the enclosure front/back panels, and secure all enclosure side panels one by one.

![Securing Enclosure Side Panels](images/gp-px-step8.jpg)

### 10. Install Enclosure Top Cover

Place the **Enclosure Top Cover ([06](#Part06))** on top of the battery, ensuring the top cover is aligned with all sides of the enclosure and sits steadily.
